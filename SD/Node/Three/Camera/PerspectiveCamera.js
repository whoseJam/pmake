...
import { PerspectiveCamera as PerspectiveCameraFromThree, Vector3 } from "three";
...
export function PerspectiveCamera(target) {
    ...
    console.log("camera=", this._.camera);
    ...
    this.vars.associate("aspect", Factory.action(this, this._.camera, "aspect", Interp.numberInterp));
