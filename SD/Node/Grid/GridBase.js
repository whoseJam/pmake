...
export class GridBase extends SDNode {
     ...
     */
    startN(start) {
        if (start === undefined) return this._.startN;
        this._.startN = start;
        return this;
    }
     ...
     */
    startM(start) {
        if (start === undefined) return this._.startM;
        this._.startM = start;
        return this;
    }
    ...
    pushRow(cols) {
        ...
        if (l > r) { this._.n++; this._.elements.push([]); }
        return this;
    }
     ...
     */
    opacity() {
        if (arguments.length === 0) return super.opacity();
