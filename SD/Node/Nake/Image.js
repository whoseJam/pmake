...
Image.prototype.x = Factory.handlerLowPrecise("x");
Image.prototype.y = Factory.handlerLowPrecise("y");
Image.prototype.href = Factory.handler("href");
Image.prototype.width = Factory.handlerLowPrecise("width");
Image.prototype.height = Factory.handlerLowPrecise("height");
Image.prototype.aspectRatio = Factory.handler("preserveAspectRatio");
