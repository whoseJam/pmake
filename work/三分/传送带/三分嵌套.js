...
sd.init(() => {
    ...
    coord2.viewX(-2.5);
    coord1.child(1).childAs(new sd.Mathjax(svg, "\\mathop{min}\\limits_{f}\\{Dist(e,f)\\}"), R.PointAtPathByRate(0, "cx", "my"));
    coord2.child(1).childAs(new sd.Mathjax(svg, "Dist(e_0,f)"), R.PointAtPathByRate(1, "cx", "my"));
