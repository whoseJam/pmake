...
sd.main(async () => {
    ...
    sd.Pointer(arr, "j", "b", 5, 30, 5).startAnimate().moveTo(ranges[rangeIndex][0] - 1).endAnimate();

    const value = new sd.Mathjax(svg, "{(} {i} {-} {(j{+1})} {+} {\\sum_{k=j+1}^iC_k} {-L} {)} ^ {2}").fontSize(15);
