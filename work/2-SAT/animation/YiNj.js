...
function init() {
    ...
    graph.at(0, 0).newNode(1, new sd.Math(graph, "Y_i"), 0);
    graph.at(1, 0).newNode(2, new sd.Math(graph, "N_i"), 1);
    graph.at(0, 1).newNode(3, new sd.Math(graph, "Y_j"), 0);
    graph.at(1, 1).newNode(4, new sd.Math(graph, "N_j"), 1);
