...
function init() {
    ...
    doors.cx(600).y(100);
    keys1.cx(600).y(240); sd.Label(keys1, "K1");
    keys2.cx(600).y(280); sd.Label(keys2, "K2");
}
...
function openDoors() {
    while (openned + 1 < doorData.length &&
        (usedKeys.has(doorData[openned + 1][0]) ||
         usedKeys.has(doorData[openned + 1][1]))) {
        openned++;
