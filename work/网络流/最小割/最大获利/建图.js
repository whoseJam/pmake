...
const R = sd.rule();
const links = [
    { from: "S", to: "中转1", cap: "P_1", xloc: "mx", yloc: "my" },
    { from: "中转1", to: "用户1", cap: "\\infty", xloc: "mx", yloc: "my" },
    { from: "中转1", to: "用户2", cap: "\\infty", xloc: "mx", yloc: "y" },
    { from: "用户1", to: "T", cap: "C_1", xloc: "x", yloc: "my" },
    { from: "用户2", to: "T", cap: "C_2", xloc: "x", yloc: "y" },
];

sd.init(() => {
    graph.at(0.5, 0).newNode("S");
    graph.at(0.5, 0.33).newNode("中转1");
    graph.at(0, 0.66).newNode("用户1");
    graph.at(1, 0.66).newNode("用户2");
