...
function value1(nodeId) {
    if (typeof(nodeId) === "string" || typeof(nodeId) === "number")
        return this._.nodes[nodeId].value();
    throw new Error("invalid arguments");
}
...
function opacity1(v1) {
    if (SDHelper.isOpacity(v1)) {
        ...
        return this._.nodes[nodeId].opacity();
    throw new Error("invalid arguments");
}
...
function opacity() {
    if (arguments.length === 1) return opacity1.call(this, arguments);
    if (arguments.length === 2) return opacity2.call(this, arguments);
    if (arguments.length === 3) return opacity3.call(this, arguments);
    throw new Error("invalid arguments"); 
}
...
function color1(v1) {
    if (SDHelper.isColor(v1)) {
        for (let id in this._.nodes)
            this._.nodes[id].color(v1);
        return this;
    } else if (SDHelper.isText(v1))
        return this._.nodes[nodeId].color();
    throw new Error("invalid arguments");
}
...
function color() {
    if (arguments.length === 1) return color1.call(this, arguments);
    if (arguments.length === 2) return color2.call(this, arguments);
    if (arguments.length === 3) return color3.call(this, arguments);
    throw new Error("invalid arguments"); 
}
