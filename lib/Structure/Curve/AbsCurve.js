...
export function AbsCurve(self) {
    ...
    self.markerStart = SDHelper.args1Func("inner", "markerStart");
    self.markerMid = SDHelper.args1Func("inner", "markerMid");
    self.markerEnd = SDHelper.args1Func("inner", "markerEnd");
    return self;
}
...
function positionFunc(name, signal0, signal1) {
    return function(value) {
        ...
        inner.d(this._.pathStr.call(this, this._.x1, this._.y1, this._.x2, this._.y2));
