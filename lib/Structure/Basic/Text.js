...
function setText(handle, text) {
    handle._groups[0][0].innerHTML = text;
}
...
function text(text) {
    ...
    this.call("on_x"); this.call("on_width");
    this.call("on_y"); this.call("on_height");
    return this;
}
...
function fontSize(fs) {
    ...
    if (!Traiter.is_valid_number(fs)) return this;
    this.dirty();
