...
export function AbsLink(self) {
    ...
    self.markerStart = SDHelper.args1Func("background", "markerStart");
    self.markerMid = SDHelper.args1Func("background", "markerMid");
    self.markerEnd = SDHelper.args1Func("background", "markerEnd");
    self.valueRule = valueRule; 
    self._.valueRule =  Rule.PointAtPathByRate(0.5, "cx", "cy");
    return self;
}
