...
export function AbsLink(self) {
    ...
    self.preIn = SDHelper.keyValueFunc.call(self, "preIn", () => {});
    self.in = SDHelper.keyValueFunc.call(self, "in", (elem) => {
        if (self._.mode === "strong") elem.opacity(0);
        elem.startAnimate(self)
        if (self._.mode === "strong") elem.opacity(1);
    });
    self.preOut = SDHelper.keyValueFunc.call(self, "preOut", () => {});
    self.out = SDHelper.keyValueFunc.call(self, "out", (elem) => {
    ...
    self.source = SDHelper.proper2Func("background", "source");
    self.target = SDHelper.proper2Func("background", "target");
...
function value(value, rate = 0.5) {
    ...
    value = SDHelper.any2Slide(value);
    ...
    this.preIn()(value);
    this.in()(value);
    this.children.push("value", value, Rule.PointAtPathByRate(this, value, 0.5));
    return this;
}
