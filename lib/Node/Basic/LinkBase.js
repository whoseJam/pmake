...
export class LinkBase extends Base {
    ...
    pointTtoS() {
        ...
        if (this.isAnimating()) {
            ...
            this.startAnimate(l).strokeDashOffset(0);
        } else this.strokeDashArray([len, len]).strokeDashOffset(0);
        return this;
    }
    ...
    fadeTtoS() {
        ...
        if (this.isAnimating()) {
            ...
            this.startAnimate(l).strokeDashArray([0, len]);
        } else this.strokeDashArray([0, len]);
        return this;
    }
}