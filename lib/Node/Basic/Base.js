...
/**
 * @typedef {import("../../Utility/Color").SDColor} SDColor
 * @typedef {import("../../Utility/Color").SDPackedColor} SDPackedColor
 * @typedef {import("../../Utility/Color").SDUnpackedColor} SDUnpackedColor
 * @typedef {import("../Node").SDNode} SDNode
 */
...
export class Base extends Node {
     ...
     * @constructor
     * @param {SDNode} node 
     * @param {"rect"|"circle"|"text"|"line"} type 
     */
