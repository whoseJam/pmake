...
export class CurveBase extends Node {
    ...
    strokeDashArray() {
        return this.dispatch("curve", "strokeDashArray", arguments);
    }

    strokeDashOffset() {
        return this.dispatch("curve", "strokeDashOffset", arguments);
    }
    ...
    value() {
        return this.dispatch("curve", "value", arguments);
    }
    ...
    revArrow() {
        return this.dispatch("curve", "revArrow", arguments);
    }
    ...
    pointStoT() {
        return this.dispatch("curve", "pointStoT", arguments);
    }

    fadeStoT() {
        return this.dispatch("curve", "fadeStoT", arguments);
    }

    pointTtoS() {
        return this.dispatch("curve", "pointTtoS", arguments);
    }

    fadeTtoS() {
        return this.dispatch("curve", "fadeTtoS", arguments);
    }
    ...
    width() {
        return this.dispatch("curve", "width", arguments);
    }

    height() {
        return this.dispatch("curve", "height", arguments);
    }
