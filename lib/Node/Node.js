...
export class Node {
    ...
    kx(k) {
        this.dirtyCheck(Const.DirtyChannel.kx);
        return this._.x + k * this._.width;
    }
    ky(k) {
        this.dirtyCheck(Const.DirtyChannel.ky);
        return this._.y + k * this._.height;
    }
    cx(cx) {
        this.dirtyCheck(Const.DirtyChannel.cx);
        if (cx === undefined) return this._.x + this._.width / 2;
        this.x(this._.x + cx - this.cx());
        return this;
    }
    cy(cy) {
        this.dirtyCheck(Const.DirtyChannel.cy);
    ...
    mx(mx) {
        this.dirtyCheck(Const.DirtyChannel.mx);
        if (mx === undefined) return this._.x + this._.width;
        this.x(this._.x + mx - this.mx());
        return this;
    }
    my(my) {
        this.dirtyCheck(Const.DirtyChannel.my);
    ...
    dirtyCheck(channel = 0) {
        ...
        } else if ((this._.dirtyByMe & channel)) {
            this.update();
        }
        return this;
    }
