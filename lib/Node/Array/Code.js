...
export class Code extends ArrayBase {
    ...
    width(width) {
        if (width === undefined) {
            console.log("check width of code");
            console.log("this-width=", this._.width);
            console.log("dirty channel=", this._.dirtyByMe & Const.DirtyChannel.width)
            console.log("pure dirty channel=", this._.dirtyByMe);
        }
    ...
    update() {
        ...
        if (l && r) {
            const focus = this.child("focus");
            const move = () => {
                const l = this.element(this.l());
                const r = this.element(this.r());
                focus.x(l.x());
                focus.y(l.y());
                focus.width(width);
                focus.height(r.my() - l.y());   
        ...
        console.log("code update finish", width, height);
        this._.width = width;
