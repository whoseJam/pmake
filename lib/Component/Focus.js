...
export function Focus(node) {
    ...
    focus.focus = function() {
        if (arguments.length === 0) elem1 = node;
        else if (arguments.length === 1 && typeof(arguments[0]) === "object") elem1 = arguments[0];
        else elem1 = node.element.apply(node, arguments);
        elem2 = undefined;
